...
# 서비스 대상 성별. 여성복 전용으로 확정되어 female 을 쓴다.
# 바꾸면 bias.json 과 body_grid.json 을 반드시 다시 만들 것.
GENDER = "female"

# CLI 실행·디버그용 산출물 경로.
# 서버 요청 경로에서는 쓰지 않습니다 (save_debug=False, save_obj=False).
...
BETA_JSON = OUT / "step2_beta.json"
BODY_OBJ = OUT / "body_est.obj"
BODY_GLB = OUT / "body.glb"
BODY_META = OUT / "body_meta.json"
